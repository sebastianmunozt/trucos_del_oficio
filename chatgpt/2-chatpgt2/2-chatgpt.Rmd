...
- Disciplina enfocada en el **desarrollo y optimización de prompts** para modelos de lenguaje (LLM).
...
- Vayan haciéndolo en sus propias cuentas de ChatGPT
...
- **Datos de entrada**: La pregunta o texto a analizar.
