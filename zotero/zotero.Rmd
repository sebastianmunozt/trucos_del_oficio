...
```markdown
### CONTEXTO
Estoy realizando un proyecto sobre [cómo el fanatismo en la música permite producir formas específicas de género].
...
1. **Resumen Corto**: Para el presente texto realiza un resumen corto con las ideas principales, en tres oraciones. 
2. **Citable**: Entregame una parte del texto que pueda ser citado. Imagine que cita este documento en su publicación. ¿Cómo lo haría? Probablemente con una sola frase seguida de la referencia. Es la condensación más intensa de la información de este documento y le obliga a ser preciso y realice la cita en formato APA. 
3. **Objetivos**: Destaque cuáles son los objetivos del texto
4. **Conceptos**: Destaca los 5 conceptos principales del texto y profundiza en ellos. Recuerda que un concepto es una construcción mental que emerge de la abstracción y generalización de características observadas en objetos, fenómenos o ideas, permitiendo su clasificación y comprensión dentro de un marco teórico específico. El concepto debe tener una definición clara y precisa, evitando ambigüedades y malentendidos. Usualmente consta de una o dos palabras. 
5. **Metodología**: Si es que es un texto con base empírica describe brevemente su metodología. 
6. **Resumen Extendido**:  Identifiqué las secciones del texto (usalmente con subtítulos) y para cada una de ellas, desarrolle los principales argumentos si los ubiese. 
...
### Pueden pegar el resumen de ChatGPT en las notas de cada artículo. 
- Ayuda a una lectura general de artículos importantes.
- Qué luego puede leer con detención e ir agregando sus propias notas o citas textuales. 
- Permite ver si artículos secundarios sirven.
